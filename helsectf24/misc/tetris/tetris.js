...
brd1 = [
    "F\\XgXXV((/)8dP2[]ZeW)+:eSZ_:Efc()W`[T+I20HH0TX..e1A10))((*:;020():CD220(*DCC120)C;CB:90);DD;21):CCKA99):LLCB902<LKC2=)^>2<Q0N^[:::8(;.^J^d<:::(*M0LNf?,:Z((<PK/7J^^:8(A,:<KJN^ZL(Y\\51:91-2[c>\\MPLPQ1U,OAef\\LLH(((QW?C__c,L(1PdYN_V^^]Q(M^^^^Q0)MV]UQ0((5UU10(((1110((((((((/(UJZGH(((7ggg`()U@eZ>B:>>:F:[8X`,X`/(\\*I@/(J.9*,8Z08:08:,8J*8:08:08:.9*,8Z49**9:*8:08:08:/HJ.9J08:28:*9**9**8Z68Z49**9:*8:08:08:*8:08J*8:49**9:*8:08:08J/)*,9`,9:*8:08P*()X(", 
    "F\\XgXXV((P2[\\/I@gZ_:EZeW)fc()+:eSW`[T.TD4(-1Q11():=-1110Z9;-201G8896^LJ<LJ:*1^^LM9LL90+/8Z;UJJA150^\\P<L<:A,A54A^\\LL(((,Q+10FgBLH(JL+([::>^]U0N:A>^]Q(LN2]UU02119UU1((R31110()9((((((D("
], 
...
brd = [
    BitMap.decode(brd1[0]), 
    BitMap.decode(brd1[1])
], 
...
state[99] = BitMap.decode("UZZGH(((7ggg`()W@X*F@*0KZ\\9**8J*;Z\\9*08:F>J09*+90.8`1)0,XN.8:08J08J,9*,9*,9*,9*.8J08J08J,9Z08J69*08:08T,8`/HJ69*08:08J69Z,9Z69*08:08J08J,9*,9*,9*,8:,9**9*/(Z/)01)*.9:(6("), state[98] = BitMap.decode("+>;d((()gggg((/0;cC_C?)X("), 
tetromino_colors = [
    [50, 50, 50],
    [138, 108, 255],
    [255, 100, 108],
